...
public class CalculatorTests
{
    ...
    public void CalculateReversalProbability_ShouldReturnCorrectProbability()
    {
        ...
        Assert.Single(probability.UpReversalDates);
        Assert.Single(probability.DownReversalDates);
    }
    ...
    public void CalculateReversalProbability_WithComplexData_ShouldBehaveCorrectly()
    {
        ...
        Assert.Equal(3, result.UpReversalDates.Count);
        ...
        Assert.Equal(2, result.DownReversalDates.Count);
    }
}